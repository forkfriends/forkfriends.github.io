...
function PrivacyPolicyScreen({ navigation }: Props) {
  ...
  const content = (
    <>
      <Text style={isDesktop ? styles.desktopTitle : styles.title}>Privacy Policy</Text>
      <Text style={isDesktop ? styles.desktopSubtitle : [styles.subtitle, styles.subtitleSpacing]}>
      ...
      <Text style={isDesktop ? styles.desktopParagraph : styles.paragraph}>
      ...
      <View style={isDesktop ? styles.desktopSection : styles.section}>
        <Text style={isDesktop ? styles.desktopSectionHeading : styles.sectionHeading}>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        <ScrollView
          contentContainerStyle={isDesktop ? styles.desktopScrollContent : styles.scrollContent}>
          {isDesktop ? <View style={styles.desktopCard}>{content}</View> : content}
        </ScrollView>
      </View>
    </SafeAreaView>
  );
